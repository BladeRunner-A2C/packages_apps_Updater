...
import co.aospa.generatebp.GenerateBpPlugin
import co.aospa.generatebp.GenerateBpPluginExtension
import co.aospa.generatebp.models.Module
...
buildscript {
    ...
    dependencies {
        classpath("co.aospa:gradle-generatebp:+")
    }
}
